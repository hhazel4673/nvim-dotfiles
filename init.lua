-- ================================================================================================
-- HAZEL'S PORTABLE NEOVIM CONFIG !!!!!!
-- ================================================================================================
...
local function mode_icon()
  ...
  if modeFinal:find "[NAV]" then
      hl = "Normal"
  elseif modeFinal:find "[INS]" then
      hl = "Insert"
  elseif modeFinal:find "[VIS]" or mode:find "[V-LINE]" or mode:find "[V-BLOCK]" then
      hl = "Visual"
...
-- LANDING SCREEN
-- ============================================================================
-- as much as I hate to say it, credit largely goes to google ai for this
--[[
function show_welcome_screen()
    ...
    vim.api.nvim_buf_set_name(1, "Welcome!")

    local lines = {
        "Welcome to Neovim!",
    }
    vim.api.nvim_buf_set_lines(buf, 0, -1, false, lines) -- writes lines to the empty buffer
...
vim.api.nvim_create_autocmd("BufLeave", {
  buffer = 1,
  callback = function()
    vim.api.nvim_buf_delete(1, { force = true, unload = true })
  end
})
-- figure out how to delete this whenever I leave it
]]--
